# Generated by Grammarinator 19.3+57.gf413939.d20201104
...
class CypherGenerator(Generator):
    ...
    def oC_ReadingClause(self, parent=None):
        ...
        choice = self.model.choice(current, 0, [
                                   0 if [6, 5, 5][i] > self.max_depth else w for i, w in enumerate([1, 1, 1])])
        if choice == 0:
    ...
    def oC_StringListNullOperatorExpression(self, parent=None):
        ...
        if self.max_depth >= 4:
            for _ in self.model.quantify(current, 0, min=0, max=inf):
                choice = self.model.choice(current, 0, [
                                           0 if [5, 5, 4][i] > self.max_depth else w for i, w in enumerate([1, 1, 1])])
                if choice == 0:
    ...
    def oC_Atom(self, parent=None):
        ...
        self.enter_rule(current)
        choice = self.model.choice(current, 0, [0 if [
                                   2, 3, 6, 3, 7, 16, 4, 2, 4][i] > self.max_depth else w for i, w in enumerate([1, 1, 1, 1, 1, 1, 1, 1, 1])])
        if choice == 0:
    ...
    def oC_FunctionName(self, parent=None):
        ...
        self.enter_rule(current)
        UnlexerRule(src='TMP', parent=current)
        self.exit_rule(current)
        return current
    ...
    def oC_CaseExpression(self, parent=None):
        ...
        self.enter_rule(current)
        choice = self.model.choice(
            current, 0, [0 if [5, 5][i] > self.max_depth else w for i, w in enumerate([1, 1])])
        if choice == 0:
